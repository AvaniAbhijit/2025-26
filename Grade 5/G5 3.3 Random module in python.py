...
# For the 'and' operator: Both conditions must be true. For 'or' operator: Any one condition can be true.
# The program below checks if the number is between the range 10 and 50 on line 18.
