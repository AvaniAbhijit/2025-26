...
# Loop through the list and print each item on line 11.

# Task 1 : Create a list of numbers from 23 to 28 on line 17.
# Task 2 : Write a for loop to print each item of the number list on line 19.
