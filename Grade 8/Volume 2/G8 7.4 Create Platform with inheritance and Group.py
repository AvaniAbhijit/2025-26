# Add a platform for the player to jump on. Create a Platform class as given in task.
# Image for platform is declared as platform_image on line
...
# Task 2: Define the init method which takes x, y, width and moving as parameters.
...
#       Set the rect.y as the y value received as parameter
