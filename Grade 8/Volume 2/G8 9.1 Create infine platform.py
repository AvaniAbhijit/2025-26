# Code from line no 130 to 146 generates new platforms if there are fewer than the maximum allowed,
...
# Task 2 : Change the value of MAX_PLATFORMS on line 32 and observe the change.
