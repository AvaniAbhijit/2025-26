# The function extract_text_from_image(image_file_path) reads an image using OpenCV,
# converts it to grayscale, and uses Tesseract OCR to extract text from it.
